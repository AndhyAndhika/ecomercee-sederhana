...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $banner = [
            [
                'name' => 'Cacao Banner',
                'picture' => 'storage/img/banner/'.Str::slug('Cacao Banner').'.webp',
                'is_active' => 1,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'picture' => 'storage/img/banner/'.Str::slug('Koji Experimental').'.webp',
                'is_active' => 1,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'picture' => 'storage/img/banner/'.Str::slug('Pengiriman Setiap Hari').'.webp',
                'is_active' => 1,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'picture' => 'storage/img/banner/'.Str::slug('April Gift 2025').'.webp',
                'is_active' => 1,
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ...
        $products = [
            [
                ...
                'picture' => 'storage/img/products/'.Str::slug('Artisan Chocolate Talasi Watu Cacao – Origin Jembrana, Bali').'.webp',
                'price' => 151200,
                'stock' => 100,
                'is_active' => 1,
                'created_at' => now(),
            ...
            [
                ...
                'picture' => 'storage/img/products/'.Str::slug('Jute Bag Crafted from high-quality natural by Talasi').'.webp',
                'price' => 98000,
                'stock' => 100,
                'is_active' => 1,
                'created_at' => now(),
            ...
            [
                ...
                'picture' => 'storage/img/products/'.Str::slug('Watu Coffee Arabica Origin Kintamani Koji Fermentation').'.webp',
                'price' => 122500,
                'stock' => 100,
                'is_active' => 1,
                'created_at' => now(),
            ...
            [
                ...
                'picture' => 'storage/img/products/'.Str::slug('Arabica Roasted Coffee Bean Origin Bajawa').'.webp',
                'price' => 150000,
                'stock' => 100,
                'is_active' => 1,
                'created_at' => now(),
